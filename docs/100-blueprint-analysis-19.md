...
Future / planned after Payments, Reports and Notifications.
...
- Provide confidence scoring and user validation for extracted measurements.
...
- Do not add payment, report or notification features in this phase.
