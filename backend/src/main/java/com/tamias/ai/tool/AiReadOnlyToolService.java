...
public class AiReadOnlyToolService {
    ...
    private static final Set<String> SEARCH_STOP_WORDS = Set.of(
        ...
        "da", "dame", "de", "del", "dice", "el", "en", "estado", "estan", "esta", "este", "estos",
        "fue", "hay", "indexado", "indexados", "la", "las", "le", "lista", "listar", "lo", "los",
        "me", "mi", "mis", "muestra", "nombre", "para", "por", "procesado", "procesados",
        "que", "quiero", "reciente", "registrada", "registradas", "registrado", "registrados", "son",
        "subido", "subidos", "tengo", "tienes", "tipo", "tu", "un", "una", "ver", "vez"
    );
    ...
    public AiToolAnswer searchProperties(String userQuestion) {
        UUID organizationId = currentUserService.getCurrentOrganizationId();
        String search = nullableSearch(extractSearchText(userQuestion, "propiedad", "propiedades", "alojamiento", "alojamientos", "casa", "casas", "bungalow", "bungalows"));
        ...
        if (search == null) {
            answer.append("Tienes estas propiedades registradas:");
        } else {
            answer.append("Encontré estas propiedades relacionadas con “").append(search).append("”:");
        }
    ...
    public AiToolAnswer lastPerformedMaintenance(String userQuestion) {
        ...
        String search = nullableSearch(extractSearchText(userQuestion,
            "ultimo", "ultima", "mantenimiento", "mantenimientos", "realizado", "realizados", "completado", "completados", "reciente", "recientes"));
    ...
    public AiToolAnswer lastPurchasedItem(String userQuestion) {
        UUID organizationId = currentUserService.getCurrentOrganizationId();
        String search = nullableSearch(extractSearchText(userQuestion,
            "cuando", "compre", "compraste", "compro", "compra", "compras", "comprado", "comprada", "ultima", "ultimo", "vez", "item", "producto"));
